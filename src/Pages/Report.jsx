...
const fetchReportData = async () => {
    ...
    try {
        ...
        const formattedData = Object.keys(response.data).map((date, index) => ({
            date,
            productionTime: response.data[date].productionTimeByDate,
            idleTime: response.data[date].idleTimeByDate,
            offTime: response.data[date].offTimeByDate,
            goodParts: response.data[date].goodpartByDate,
            badParts: response.data[date].badpart,
            partCount: response.data[date].actualProducedQuantityByDate,
            availability: parseFloat(response.data[date].availabilityByDate),
            performance: parseFloat(response.data[date].performanceByDate),
            quality: parseFloat(response.data[date].qualityByDate),
            oee: parseFloat(response.data[date].oeeByDate),
            key: index
          }));
    ...
    return(
        ...
        <Layout>
            <Content>
                <div> 
                <Card title="Production Report" style={{ margin: '24px' }}>
